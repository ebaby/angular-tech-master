(function (window) {
    var global = {
        apiPath:"//toapiv410.yqj.cn/api/",// "https://oapiv3400.yqj.cn/api/",////'http://moapi.yqj.cn/MockAPI/',//'http://toapi.yqj.cn/api/',
        curl: "//tauthcode.yqj.cn/ShowCode",
        appver: '4.0.1',
        //appver: '3.4.0',
        uploadPath: '//tres.yqj.cn/ResUp.aspx',
        downloadPath: '//tdocgen.yqj.cn/downloadv32.ashx',
        platformurl: "//twww.yqj.cn/index.html",//"http://dwww.yqj.cn/index.html",
        libPath: '/js/libs/',
        appPath: '/js/app/',
        domain: '//twww.yqj.cn/',
    };
