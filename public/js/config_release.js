(function (window) {
    var global = {
        apiPath:"//oapiv410.yqj.cn/api/",// "https://oapiv3400.yqj.cn/api/",////'http://moapi.yqj.cn/MockAPI/',//'http://toapi.yqj.cn/api/',
        curl: "//authcode.yqj.cn/ShowCode",
        appver: '4.0.1',
        //appver: '3.4.0',
        uploadPath: '//res.yqj.cn/ResUp.aspx',
        downloadPath: '//docgen.yqj.cn/downloadv32.ashx',
        platformurl: "//www.yqj.cn/index.html",//"http://dwww.yqj.cn/index.html",
        libPath: '/js/libs/',
        appPath: '/js/app/',
        domain: '//www.yqj.cn/',
    };
